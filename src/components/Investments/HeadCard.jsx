  ...
  return (
    ...
    >
      ...
      >
        ...
        {width > 700 ? (
          <Box>
            <Button size="small" variant="text" sx={{ color: '#979BAC', opacity: 0.5 }}>
              1H
            </Button>
            <Button size="small" variant="text" sx={{ color: '#979BAC', opacity: 0.5 }}>
              1D
      ...
      <Box marginX={{ xs: 0, sm: 0, md: 7 }}>
        <Box display="flex" flexDirection={{ xs: 'column', sm: 'column', md: 'row' }}>
          <Box>
            ...
            ></Box>
            <Box marginTop={width > 700 ? 8 : 2} display="flex" justifyContent={'space-between'} alignItems={'center'}>
              <Box display={'flex'} alignItems={'center'} flexDirection={{ xs: 'column', sm: 'row' }}>
                ...
                <Chip
                  ...
                  avatar={
                    <Avatar alt="Natacha" sx={{ width: '16px', height: '16px' }} src="/static/images/avatar/1.jpg" />
                  }
                  label={
                    <Box>
                      {width > 700 ? (
              ...
              <Box display={width > 700 ? 'none' : 'flex'}>
                <Button size="small" variant="text" sx={{ color: '#979BAC', opacity: 0.5, minWidth: '15px' }}>
                  1H
                </Button>
                <Button
                  // size="small"
