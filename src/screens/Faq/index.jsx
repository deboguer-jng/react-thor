          ...
          {data.map((v, i) => (
            <Box marginBottom={'5px'}>
              ...
              >
                ...
                {activeTab === i ? <img src={imgMinus} /> : <img src={imgPlus} width={'24px'} height="24px" />}
              </Button>
              {activeTab === i ? (
                <Box
                  sx={{
                ...
                >
                  ...
                  <Box marginLeft={2}>
                    ...
                    >
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Blanditiis impedit, repellendus quasi
                      consectetur harum commodi eligendi recusandae tempora aperiam cum iste, aut modi, corrupti ipsum
                      assumenda quam sunt. Ipsum, praesentium?
                    </Typography>
                  </Box>
                </Box>
              ) : null}
